...
int main(){
    std::vector<std::pair<const char*, std::function<void()>>> tests = {
        ...
        {"maps_route_corridor_varies_with_width", test_maps_route_corridor_varies_with_the_width_of_the_road},
        {"maps_route_corridor_interpolates_width", test_maps_route_corridor_interpolates_the_width_along_a_segment},
        {"maps_route_corridor_warning_fraction", test_maps_route_corridor_warns_as_a_fraction_of_the_width},
        {"maps_route_corridor_bad_widths", test_maps_route_corridor_rejects_bad_widths},
        {"maps_route_corridor_empty_widths", test_maps_route_corridor_without_widths_matches_the_uniform_check},
