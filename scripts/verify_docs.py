...
PUBLIC_HEADER_DOCS = {
    ...
    "bounded_bypass": "docs/navigation.md",
    "camera": "docs/camera_module.md",
    "camera_lidar": "docs/perception_module.md",
    "monitors": "docs/monitors_module.md",
    "scan_mask": "docs/lidar_module.md",
    ...
    "route_follower": "docs/navigation.md",
